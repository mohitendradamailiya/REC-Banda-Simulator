function abc() {
    ...
    function calc() {
        ...
        datapoints1.push({x: Math.log((-2.613) * ((t3 / mean)^2) + (85.78 * (t3 / mean) )+ 434.8), y: Math.log(t14 * t24)});
        datapoints1.push({x: Math.log((-2.613) * ((t32 / mean)^2) + 85.78 * (t32 / mean) + 434.8), y:Math.log(t15 * t25)});
...
function table2() {
    ...
    document.getElementById('start7').innerHTML =  (t1 * t2);
    document.getElementById('start8').innerHTML =  Math.log(t1 * t2);
    ...
    document.getElementById('go7').innerHTML =  (t12 * t22);
    document.getElementById('go8').innerHTML =  Math.log(t12 * t22);
    ...
    document.getElementById('up6').innerHTML = Math.log((-2.613) * ((t33 / mean1)^2 )+
        85.78 * (t33 / mean1) + 434.8);
    document.getElementById('up7').innerHTML =   (t13 * t23);
    document.getElementById('up8').innerHTML =   Math.log(t13 * t23);
    ...
    document.getElementById('now6').innerHTML = Math.log((-2.613) * ((t34 / mean1)^2) +
        85.78 * (t34 / mean1) + 434.8);
    document.getElementById('now7').innerHTML =  (t14 * t24);
    document.getElementById('now8').innerHTML =  Math.log(t14 * t24);
    ...
    document.getElementById('how6').innerHTML = Math.log((-2.613) * ((t35 / mean1)^2) +
        85.78 * (t35 / mean1) + 434.8);
    document.getElementById('how7').innerHTML =   (t15 * t25);
    document.getElementById('how8').innerHTML =  Math.log(t15 * t25);
    ...
    document.getElementById('shift6').innerHTML = Math.log((-2.613) * ((m3 / mean1)^2) +
        85.78 * (m3 / mean1) + 434.8);
    document.getElementById('shift7').innerHTML =  (m1 * m2);
    document.getElementById('shift8').innerHTML =  Math.log(m1 * m2);
    ...
    document.getElementById('sad6').innerHTML = Math.log((-2.613) * ((n3 / mean1)^2) +
        85.78 * (n3 / mean1) + 434.8);
    document.getElementById('sad7').innerHTML =  (n1 * t2);
    document.getElementById('sad8').innerHTML =  Math.log(n1 * n2);
    ...
    document.getElementById('take6').innerHTML = Math.log((-2.613) * ((l3 / mean1)^2) +
        85.78 * (l3 / mean1) + 434.8);
    document.getElementById('take7').innerHTML = (l1 * l2);
    document.getElementById('take8').innerHTML =  Math.log(l1 * l2);
    ...
    document.getElementById('low6').innerHTML = Math.log((-2.613) * ((h3 / mean1)^2) +
        85.78 * (h3 / mean1) + 434.8);
    document.getElementById('low7').innerHTML = (h1 * h2);
    document.getElementById('low8').innerHTML =  Math.log(h1 * h2);
    ...
    document.getElementById('high6').innerHTML = Math.log((-2.613) * ((k3 / mean1)^2) +
        85.78 * (k3 / mean1) + 434.8);
    document.getElementById('high7').innerHTML = (k1 * k2);
    document.getElementById('high8').innerHTML = Math.log(k1 * k2);
